...
namespace AppMenuApplet {
	 ...
	 * .appmenu-arrow node so the theme can match it to the menu body.
	 *
	 * Ported from budgie-desktop's MenuArrow (src/panel/applets/budgie-menu).
	 */
	public class MenuArrow : Gtk.DrawingArea {
		...
		construct {
			this.get_style_context().add_class("appmenu-arrow");
		}
